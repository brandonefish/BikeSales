namespace eBikes.Entities
{
    ...
    public partial class Job
    {
        ...
        [StringLength(1, ErrorMessage = "Status code is 1 character long")]
        public string StatusCode { get; set; }

        [Required(ErrorMessage = "Vehicle Identification is required.")]
        [StringLength(50, ErrorMessage = "Vehicle Identification has a maximum length of 50 characters.")]
